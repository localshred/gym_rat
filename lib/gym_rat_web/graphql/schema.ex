defmodule GymRatWeb.Graphql.Schema do
  ...
  import_types(GymRatWeb.Graphql.GridHolds.Types)
  ...
  import_types(GymRatWeb.Graphql.GridHolds.Queries)
  ...
  import_types(GymRatWeb.Graphql.GridHolds.Mutations)
  ...
  query do
    ...
    import_fields(:grid_holds_queries)
  ...
  mutation do
    ...
    import_fields(:grid_holds_mutations)
